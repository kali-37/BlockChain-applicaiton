...
async function main() {
  ...
  // Deploy the contract
  const companyWallet = process.env.COMPANY_WALLET_ADDRESS || deployer.address;
  ...
  const deploymentTransaction = await MatrixCore.getDeployTransaction(companyWallet, rootUser);
