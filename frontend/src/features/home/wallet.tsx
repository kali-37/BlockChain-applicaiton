...
function Wallet() {
    ...
    return (
        <>
            {/* <section className="bg-gray-900 text-white h-[90.5vh] p-4 overflow-hidden">
                <div className=" w-[90%]  md:w-[50%] mx-auto h-[80%] relative border  ">
            ...
            <section className="bg-black p-8  min-h-[80vh] flex items-center justify-center overflow-x-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2 space-y-8 md:space-y-0 md:space-x-6 w-[80%] max-w-[1000px] mx-auto ">
