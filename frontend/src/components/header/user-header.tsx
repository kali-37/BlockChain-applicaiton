            ...
            <header className="py-6">
                <div className="flex justify-between w-[90%] mx-auto items-center max-w-[900px] ">
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <CgMenuLeft className="text-xl md:text-3xl text-green-400" />
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex items-center border-[1px] cursor-pointer border-green-300 rounded-xl gap-1 p-1">
                            <PiWalletLight className="text-xl md:text-2xl" />
                            <p>Ox*****a</p>
                        </div>
                        <div className="p-2 border-green-300 border-[1px] rounded-3xl">
